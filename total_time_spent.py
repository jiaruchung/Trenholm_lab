...
file=r'E:\mouse_never_seen_others\day1\con1\cleanData\Data_quadrants.csv' #make list of paths
...
file2=r'E:\mouse_never_seen_others\day1\con2\cleanData\Data_quadrants.csv' #make list of paths
...
return con2_array
    ...
    new_dir=r'E:\Nathan\Results'
    file_name = "total_time_spent_mnsom"
