...
def occu_heatmap(pos): 
    """
    Args: 
        pos: animal pos X and Y in cols 1 and 2 in excel files  
    returns:
...
def ur(m):
    """
    Args: 
        m: occu (the bin squares, or matrices) resulted by occu_heatmap()
    returns:
        first: flipped matrices
    """
...
condition_1_filenames = glob.glob(os.path.join(r'C:\Users\jc552\Desktop\Trenholm_lab-master\Blinds-c-excel','*.xlsx'))
condition_2_filenames = glob.glob(os.path.join(r'C:\Users\jc552\Desktop\Trenholm_lab-master\Blinds-m-excel','*.xlsx'))
